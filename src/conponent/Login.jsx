  ...
  return (
    <div className='max-w-md mx-auto mt-10 p-5 border border-gray-300 rounded-lg bg-white shadow-lg'>
        <div className='flex justify-between ml-2'>
            ...
            <img src="src/assets/listify-high-resolution-logo.png" alt="" className="w-10 h-10"/>
        </div>
        ...
        <div className='flex justify-between'>
            ...
            <Link to={"/Signin"} className='mt-2 px-6 py-2 bg-black text-2xl text-white hover:text-red-500 font-semibold'>Signup</Link>
        </div>
    </div>
  )
}
